...
void grid(int i, char c){
    ...
    printf("\v\v\v");
    printf("\t\t\t%s |%s |%s \n", 
        (a[0]=='X'?"\033[1m\033[31m X\033[0m":(a[0]=='O'?"\033[1m\033[34m O\033[0m":"  ")), 
        (a[1]=='X'?"\033[1m\033[31m X\033[0m":(a[1]=='O'?"\033[1m\033[34m O\033[0m":"  ")), 
        (a[2]=='X'?"\033[1m\033[31m X\033[0m":(a[2]=='O'?"\033[1m\033[34m O\033[0m":"  ")));
    printf("\t\t\t===========\n");
    printf("\t\t\t%s |%s |%s \n", 
        (a[3]=='X'?"\033[1m\033[31m X\033[0m":(a[3]=='O'?"\033[1m\033[34m O\033[0m":"  ")), 
        (a[4]=='X'?"\033[1m\033[31m X\033[0m":(a[4]=='O'?"\033[1m\033[34m O\033[0m":"  ")), 
        (a[5]=='X'?"\033[1m\033[31m X\033[0m":(a[5]=='O'?"\033[1m\033[34m O\033[0m":"  ")));
    printf("\t\t\t===========\n");
    printf("\t\t\t%s |%s |%s \n", 
        (a[6]=='X'?"\033[1m\033[31m X\033[0m":(a[6]=='O'?"\033[1m\033[34m O\033[0m":"  ")), 
        (a[7]=='X'?"\033[1m\033[31m X\033[0m":(a[7]=='O'?"\033[1m\033[34m O\033[0m":"  ")), 
        (a[8]=='X'?"\033[1m\033[31m X\033[0m":(a[8]=='O'?"\033[1m\033[34m O\033[0m":"  ")));
    printf("\v\v\v");
